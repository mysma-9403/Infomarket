...
abstract class BenchmarkFieldFactoryBase implements BenchmarkFieldFactory {
	...
	protected function initValueFieldProperty($field) {
		$field['valueField'] = $this->benchmarkFieldDataBaseUtils->getValueFieldProperty($field['fieldType'], $field['valueNumber']);
	
		return $field;
	}
	
	protected function initNoteFieldProperty($field) {
		$field['noteField'] = $this->benchmarkFieldDataBaseUtils->getNoteFieldProperty($field['fieldType'], $field['valueNumber']);
