...
class ExcelExportLogic {
	...
	protected function fillProperties(&$excel) {
		...
		$excel->getProperties()->setCreator("Infomarket")->setLastModifiedBy("Infomarket")->setTitle(
				$date->format('Y-m-d') . " - benchmark")->setSubject("InfoMarket - Benchmark")->setDescription(
				"InfoMarket - Benchmark")->setKeywords("InfoMarket benchmark products");
	}
