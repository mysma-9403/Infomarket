...
use AppBundle\Repository\Applications\BrandRepository;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;

class BrandController extends DummyController {
	...
	protected function getIndexParams(Request $request, array $params, $category) {
		...
		$repository = new BrandRepository($em, $em->getClassMetadata($this->getEntityType()));
