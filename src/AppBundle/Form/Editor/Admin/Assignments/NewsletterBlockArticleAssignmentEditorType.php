...
class NewsletterBlockArticleAssignmentEditorType extends BaseEntityEditorType {
	...
	protected function addFields(FormBuilderInterface $builder, array $options) {
		...
		$this->addTextField($builder, 'alternativeName', 'label.newsletterBlockArticleAssignment.alternativeName', false);
		$this->addTextField($builder, 'alternativeSubname', 'label.newsletterBlockArticleAssignment.alternativeSubname', false);
		$this->addTextField($builder, 'alternativeBrands', 'label.newsletterBlockArticleAssignment.alternativeBrands', false);
