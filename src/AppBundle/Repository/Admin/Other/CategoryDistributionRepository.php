...
class CategoryDistributionRepository extends BaseRepository implements DependentItemsRepository {

	const INSERT_ITEMS_SQL = "INSERT INTO category_distributions (category_id, up_to_date) VALUES (?, 0)";

	const INVALIDATE_ITEMS_BY_CATEGORIES_SQL = "UPDATE category_distributions cd
			SET cd.up_to_date = 0 WHERE cd.category_id IN (?)";
	...
	protected function getEntityType() {
		return CategoryDistribution::class;
	}
}
