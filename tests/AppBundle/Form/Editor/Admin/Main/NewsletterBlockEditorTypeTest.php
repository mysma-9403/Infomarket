...
class NewsletterBlockEditorTypeTest extends SimpleEditorTypeTest {
	...
	protected function getExtensions() {
		$type = new NewsletterBlockEditorType($this->newsletterBlockTemplateTransformer, 
				$this->newsletterPageTransformer);
	...
	protected function assertEntity($entity) {
		...
		$this->assertSame(self::NEWSLETTER_BLOCK_TEMPLATE_NAME, 
				$entity->getNewsletterBlockTemplate()->getName());
	...
	private function getNewsletterBlockTemplateTransformerMock() {
		...
		$mock->expects($this->any())->method('reverseTransform')->willReturn(
				$this->getNewsletterBlockTemplate());
