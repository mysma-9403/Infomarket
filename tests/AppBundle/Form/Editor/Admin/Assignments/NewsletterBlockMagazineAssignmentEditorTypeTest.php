...
class NewsletterBlockMagazineAssignmentEditorTypeTest extends SimpleEditorTypeTest {
	...
	protected function getExtensions() {
		$type = new NewsletterBlockMagazineAssignmentEditorType($this->newsletterBlockTransformer, 
				$this->magazineTransformer);
