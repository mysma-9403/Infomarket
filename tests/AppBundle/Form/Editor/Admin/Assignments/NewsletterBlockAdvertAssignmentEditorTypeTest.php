...
class NewsletterBlockAdvertAssignmentEditorTypeTest extends SimpleEditorTypeTest {
	...
	protected function getExtensions() {
		$type = new NewsletterBlockAdvertAssignmentEditorType($this->newsletterBlockTransformer, 
				$this->advertTransformer);
