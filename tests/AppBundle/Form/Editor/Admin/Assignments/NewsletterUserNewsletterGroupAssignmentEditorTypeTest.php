...
class NewsletterUserNewsletterGroupAssignmentEditorTypeTest extends SimpleEditorTypeTest {
	...
	protected function setUp() {
		$this->newsletterUserTransformer = $this->getEntityTransformerMock($this->getNewsletterUser(), 
				self::NEWSLETTER_USER_ID);
		$this->newsletterGroupTransformer = $this->getEntityTransformerMock($this->getNewsletterGroup(), 
				self::NEWSLETTER_GROUP_ID);
		
		parent::setUp();
	}

	protected function getExtensions() {
		$type = new NewsletterUserNewsletterGroupAssignmentEditorType($this->newsletterUserTransformer, 
				$this->newsletterGroupTransformer);
