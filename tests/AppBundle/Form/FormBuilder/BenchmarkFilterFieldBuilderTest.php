...
class BenchmarkFilterFieldBuilderTest extends TestCase {
	...
	const DECIMAL_FIELD = ['valueField' => 'decimal1', 'filterName' => 'Super price', 
			'fieldType' => BenchmarkField::DECIMAL_FIELD_TYPE];

	const INTEGER_FIELD = ['valueField' => 'integer12', 'filterName' => 'Num of wheels', 
			'fieldType' => BenchmarkField::INTEGER_FIELD_TYPE];

	const BOOLEAN_FIELD = ['valueField' => 'integer3', 'filterName' => 'Has super power', 
			'fieldType' => BenchmarkField::BOOLEAN_FIELD_TYPE];

	const STRING_FIELD = ['valueField' => 'string7', 'filterName' => 'More info', 
			'fieldType' => BenchmarkField::STRING_FIELD_TYPE];

	const OPTIONS = ['choices' => [], 'booleanChoices' => []];
