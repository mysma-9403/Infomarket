...
class BenchmarkEditorFieldBuilderTest extends TestCase {
	...
	const DECIMAL_FIELD = ['valueField' => 'decimal1', 'fieldName' => 'Super price', 
			'fieldType' => BenchmarkField::DECIMAL_FIELD_TYPE];

	const INTEGER_FIELD = ['valueField' => 'integer12', 'fieldName' => 'Num of wheels', 
			'fieldType' => BenchmarkField::INTEGER_FIELD_TYPE];

	const BOOLEAN_FIELD = ['valueField' => 'integer3', 'fieldName' => 'Has super power', 
			'fieldType' => BenchmarkField::BOOLEAN_FIELD_TYPE];

	const STRING_FIELD = ['valueField' => 'string7', 'fieldName' => 'More info', 
