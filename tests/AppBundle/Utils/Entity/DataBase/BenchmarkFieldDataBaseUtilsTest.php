...
class BenchmarkFieldDataBaseUtilsTest extends TestCase {
	...
	public function testGivenSingleEnumThenStringValueFieldIsSet() {
		$result = $this->utils->getValueFieldProperty(BenchmarkField::SINGLE_ENUM_FIELD_TYPE, 
				self::VALUE_NUMBER);
	...
	public function testGivenDecimalThenDecimalNoteFieldIsSet() {
		...
		$this->assertEquals(
				BenchmarkFieldDataBaseUtils::DECIMAL_NAME . BenchmarkFieldDataBaseUtils::NOTE .
						 self::VALUE_NUMBER, $result);
	}
	...
	public function testGivenIntegerThenIntegerNoteFieldIsSet() {
		...
		$this->assertEquals(
				BenchmarkFieldDataBaseUtils::INTEGER_NAME . BenchmarkFieldDataBaseUtils::NOTE .
						 self::VALUE_NUMBER, $result);
	}
	...
	public function testGivenSingleEnumThenStringNoteFieldIsSet() {
		...
		$this->assertEquals(
				BenchmarkFieldDataBaseUtils::STRING_NAME . BenchmarkFieldDataBaseUtils::NOTE . self::VALUE_NUMBER, 
				$result);
	}
