...
class NoteBenchmarkFieldFactoryTest extends TestCase {
	...
	const SINGLE_ENUM_EXPECTED = [
			'fieldType' => self::SINGLE_ENUM_FIELD ['fieldType'],
	...
	public function testGivenDecimalThenPropertiesAreSet() {
		$logic = new NoteBenchmarkFieldFactory(
	...
	private function getBenchmarkFieldDataBaseUtilsMock() {
		...
		$repository->expects($this->once())
		->method('getNoteFieldProperty')
		->willReturn(self::NOTE_FIELD);
