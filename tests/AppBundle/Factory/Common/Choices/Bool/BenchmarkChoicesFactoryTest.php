...
use AppBundle\Factory\Common\Choices\Bool\BenchmarkChoicesFactory;
use AppBundle\Filter\Base\Filter;
use PHPUnit\Framework\TestCase;

class BenchmarkChoicesFactoryTest extends TestCase {

	const INVALID_VALUE = - 1;

	/**
	 *
	 * @var BenchmarkChoicesFactory
	 */
	protected $factory;

	protected function setUp() {
		$this->factory = new BenchmarkChoicesFactory();
	}
