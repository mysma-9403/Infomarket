...
class PreparedEntryFactoryTest extends CommonTestCase {
	...
	public function testGetEntriesSubscribed01() {
		$this->getRowEntries(['test@wp.pl'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => true]));
	}

	public function testGetEntriesSubscribed02() {
		$this->getRowEntries(['test@wp.pl', 0], 
				array(['mail' => 'test@wp.pl', 'subscribed' => true]));
	}
	...
	public function testGetEntriesSubscribed05() {
		$this->getRowEntries(['test@wp.pl', 'false'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => true]));
	}

	public function testGetEntriesSubscribedList01() {
		$this->getRowEntries(['test@wp.pl;test@wp.pl'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => true], 
						['mail' => 'test@wp.pl', 'subscribed' => true]));
	}

	public function testGetEntriesSubscribedList02() {
		$this->getRowEntries(['test1@wp.pl;test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => true], 
	...
	public function testGetEntriesUnsubscribed01() {
		$this->getRowEntries(['test@wp.pl', 1], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}
	...
	public function testGetEntriesRezygnacja21() {
		$this->getRowEntries(['test@wp.pl_rezygnacja'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRezygnacja22() {
		$this->getRowEntries(['test@wp.pl-rezygnacja'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}
	...
	public function testGetEntriesRez01() {
		$this->getRowEntries(['rez_test@wp.pl'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRez02() {
		$this->getRowEntries(['rez-test@wp.pl'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}
	...
	public function testGetEntriesRez21() {
		$this->getRowEntries(['test@wp.pl_rez'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRez22() {
		$this->getRowEntries(['test@wp.pl-rez'], 
				array(['mail' => 'test@wp.pl', 'subscribed' => false]));
	}
	...
	public function testGetEntriesRezList01() {
		$this->getRowEntries(['rez_test1@wp.pl;test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
						['mail' => 'test2@wp.pl', 'subscribed' => true]));
	}
	...
	public function testGetEntriesRezList03() {
		$this->getRowEntries(['rez_test1@wp.pl;rez_test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
	...
	public function testGetEntriesRezList05() {
		$this->getRowEntries(['rez_test1@wp.pl; rezygnacja_test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
						['mail' => 'test2@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRezList06() {
		$this->getRowEntries(['test1@wp.pl_rez; rezygnacja_test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
						['mail' => 'test2@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRezList07() {
		$this->getRowEntries(['test1@wp.pl_rezygnacja; rezygnacja_test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
						['mail' => 'test2@wp.pl', 'subscribed' => false]));
	}

	public function testGetEntriesRezList08() {
		$this->getRowEntries(['test1@wp.pl_rezygnacja; test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => false], 
						['mail' => 'test2@wp.pl', 'subscribed' => true]));
	}

	public function testGetEntriesRezList09() {
		$this->getRowEntries(['test1@wp.pl; rezygnacja_test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl', 'subscribed' => true], 
						['mail' => 'test2@wp.pl', 'subscribed' => false]));
	}
	...
	public function testGetEntriesSpace01() {
		$this->getRowEntries(['test1@wp.pl test2@wp.pl'], 
				array(['mail' => 'test1@wp.pl test2@wp.pl', 'subscribed' => true]));
	}
